...
public class Bird extends AbstractAnimal{
    ...
    public Bird(String name, String type, int year, String favFood){
        maxID++;
        this.ID = maxID;
        this.name = name;
    ...
    public String move(String direction, int distance){
        ...
        if(energy == 0){
            ...
            System.out.println(this.name + " flew " + direction + distance + " feet!");
        }
        return "Success";
    }
    ...
    public String reproduce(String type, Animal partner, String name){
        ...
        Bird baby = new Bird(this.animalType, name, this.yearDiscovered, this.favFood);
